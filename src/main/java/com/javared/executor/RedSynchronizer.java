...
abstract public class RedSynchronizer<INPUT, OUTPUT> {

    // Constants

    private static final ReturnClassifier.ReturnClassifier0 RETURN_CLASSIFIER_0 =
            new ReturnClassifier.ReturnClassifier0();
    ...
    abstract protected static class ReturnClassifier<COMMAND, TRANSFORMER> extends PrerequisitesHolder {
        ...
        public static class ReturnClassifier0 extends ReturnClassifier<Executables.Command0, Object> {
            ...
            @Override
            protected Object transformer(RedFuture[] oldPrerequisites, Marker... markers) {
                return null;
            }
        ...
        public static class ReturnClassifierN extends
            ...
            @Override
            protected void call(Executables.CommandN c, OpenRedFuture future) {
                c.call(future, new Results(prerequisites()));
            }
    ...
    protected static class Executables {
        ...
        public interface Command0 {
            ...
            void call(OpenRedFuture status);

        }

        public interface Command1<T0> {

            void call(OpenRedFuture status, T0 f0);

        }

        public interface Command2<T0, T1> {

            void call(OpenRedFuture status, T0 f0, T1 f1);

        }

        public interface Command3<T0, T1, T2> {

            void call(OpenRedFuture status, T0 f0, T1 f1, T2 f2);

        }

        public interface Command4<T0, T1, T2, T3> {

            void call(OpenRedFuture status, T0 f0, T1 f1, T2 f2, T3 f3);

        }

        public interface Command5<T0, T1, T2, T3, T4> {

            void call(OpenRedFuture status, T0 f0, T1 f1, T2 f2, T3 f3, T4 f4);

        }

        public interface Command6<T0, T1, T2, T3, T4, T5> {

            void call(OpenRedFuture status, T0 f0, T1 f1, T2 f2, T3 f3, T4 f4, T5 f5);

        }

        public interface Command7<T0, T1, T2, T3, T4, T5, T6> {

            void call(OpenRedFuture status, T0 f0, T1 f1, T2 f2, T3 f3, T4 f4, T5 f5, T6 f6);

        }

        public interface Command8<T0, T1, T2, T3, T4, T5, T6, T7> {

            void call(OpenRedFuture status, T0 f0, T1 f1, T2 f2, T3 f3, T4 f4, T5 f5, T6 f6, T7 f7);

        }

        public interface Command9<T0, T1, T2, T3, T4, T5, T6, T7, T8> {

            void call(OpenRedFuture status, T0 f0, T1 f1, T2 f2, T3 f3, T4 f4, T5 f5, T6 f6, T7 f7, T8 f8);

        }

        public interface Command10<T0, T1, T2, T3, T4, T5, T6, T7, T8, T9> {

            void call(OpenRedFuture status, T0 f0, T1 f1, T2 f2, T3 f3, T4 f4, T5 f5, T6 f6, T7 f7, T8 f8, T9 f9);

        }

        public interface CommandN {

            void call(OpenRedFuture status, Results results);
